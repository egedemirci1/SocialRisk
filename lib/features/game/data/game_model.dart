...
class GameModel {
  ...
  factory GameModel.fromJson(Map<String, dynamic> json, String docId) {
    return GameModel(
      ...
      spinningTarget: json['spinningTarget']?.toString(),
      ...
      lastRoundPlayerId: json['lastRoundPlayerId']?.toString(),
      lastRoundMood: json['lastRoundMood']?.toString(),
      selectedCategory: json['selectedCategory']?.toString(),
      selectedDifficulty: json['selectedDifficulty']?.toString(),
      ...
      hotCategory: json['hotCategory']?.toString(),
